...
@Inject constructor(authenticationRepository: AuthenticationRepository,
                    private val contactRepository: ContactRepository) : DisposableViewModel() {
    ...
    val getContacts by lazy {
        LiveDataReactiveStreams.fromPublisher(
                authenticationRepository.getUser().flatMap { contactRepository.getContacts() })
    }
